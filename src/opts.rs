use {crate::types::NixBranch, clap::Clap};
...
mod tests {
    ...
    fn default_opts() -> Result<()> {
        ...
        assert_eq!(result, super::Opts::default(),);
    ...
    fn opts_long() -> Result<()> {
        ...
        assert_eq!(
            ...
            super::Opts {
                ...
                packages: Some(vec![
                    "mozilla/nixpkgs-mozilla".to_owned(),
                    "stedolan/jq".to_owned()
                ]),
            },
        );
